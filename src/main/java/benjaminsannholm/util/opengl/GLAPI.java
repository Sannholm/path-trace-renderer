...
public final class GLAPI
{
    ...
    private static final int MAX_INFO_LOG_LENGTH = 1000;
    ...
    {
        final String result = GL20.glGetShaderInfoLog(handle, MAX_INFO_LOG_LENGTH);
        checkError();
        return result;
    }
    ...
    {
        final String result = GL20.glGetProgramInfoLog(handle, MAX_INFO_LOG_LENGTH);
        checkError();
        return result;
    }
