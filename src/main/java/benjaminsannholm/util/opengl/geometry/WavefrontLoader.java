...
public class WavefrontLoader
{
    ...
    {
        final List<Vector3> vertexPositions = Lists.newArrayList();
        final List<Vector3> vertexNormals = Lists.newArrayList();
        final List<Vector2> vertexUVs = Lists.newArrayList();
