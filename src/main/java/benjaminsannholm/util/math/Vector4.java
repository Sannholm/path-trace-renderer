...
public class Vector4 extends Vector<Vector4>
{
    ...
    {
        return create(
                m.m00() * getX() + m.m10() * getY() + m.m20() * getZ() + m.m30() * getW(),
                m.m01() * getX() + m.m11() * getY() + m.m21() * getZ() + m.m31() * getW(),
                m.m02() * getX() + m.m12() * getY() + m.m22() * getZ() + m.m32() * getW(),
                m.m03() * getX() + m.m13() * getY() + m.m23() * getZ() + m.m33() * getW());
    }
