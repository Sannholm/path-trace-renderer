...
import static benjaminsannholm.pathtracerenderer.CLTest.InfoUtil.checkCLError;
import static benjaminsannholm.pathtracerenderer.CLTest.InfoUtil.getDeviceInfoInt;
import static benjaminsannholm.pathtracerenderer.CLTest.InfoUtil.getDeviceInfoLong;
import static benjaminsannholm.pathtracerenderer.CLTest.InfoUtil.getDeviceInfoPointer;
import static benjaminsannholm.pathtracerenderer.CLTest.InfoUtil.getDeviceInfoStringUTF8;
import static benjaminsannholm.pathtracerenderer.CLTest.InfoUtil.getPlatformInfoStringUTF8;
...
public final class CLTest
{
            ...
            for (int d = 0; d < devices.capacity(); d++)
            {
                ...
                if ((exec_caps & CL_EXEC_NATIVE_KERNEL) == CL_EXEC_NATIVE_KERNEL)
                {
                    ...
                    errcode = clEnqueueNativeKernel(queue, kernel = CLNativeKernel.create(
                            args -> System.out.println("\t\tKERNEL EXEC argument: " + memByteBuffer(args, 4).getInt(0) + ", should be 1337")), kernelArgs, null, null, null, ev);
                    checkCLError(errcode);
    ...
    public static final class InfoUtil
    {
        private InfoUtil()
        {
        }
